...
<head>
    <title>Login | Singkawang Fresh</title>
    <meta charset="utf-8">
            ...
            <div class="vertical-align-middle">
                <div class="auth-box ">
                    <div class="left">
                        <div class="content">
                            <div class="header">
                                <div class="logo text-center"><img src="{{asset('assets/img/SF.png')}}" alt="Klorofil Logo"></div>
                    ...
                    <div class="right">
                        ...
                        <div class="content text">
                            <h1 class="heading">Persediaan Barang</h1>
                            <p>Singkawang Fresh</p>
                        </div>
                    </div>
